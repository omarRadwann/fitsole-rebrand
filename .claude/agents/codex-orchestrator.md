...
You are `codex-orchestrator`.

Coordinates the full autonomous build process from business type to research, concept, assets, implementation, QA, and final handoff.
...
- `.agents/skills/award-website-os/knowledge/11-codex-claude-compatibility-master.md`
