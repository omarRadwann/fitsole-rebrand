# 15 — Prompt and Context Engineering for Claude Code

## Mission

Make Claude Code use the OS correctly without drowning it in context.

## Important Rule

Keep `AGENTS.md` short. Put long knowledge in skills/references.

Claude Code skills are designed as a directory with `SKILL.md` plus optional scripts, references, assets, and agents. Claude Code uses progressive disclosure: it sees skill metadata first and loads the full skill when needed.
...
- ask Claude Code to summarize assumptions
- keep asset ledger
- keep QA report
